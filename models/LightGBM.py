...
study_model.optimize(objective_lgb, n_trials = 30)  # type: ignore
...
# print(f"N iter: {opt_model.n_iter_}") #type: ignore
print(f"Elapsed time: {elapsed_time:.4f} seconds\n")


# Initialize the LGBMRegressor
# lgb_model = LGBMRegressor(n_jobs=-multiprocessing.cpu_count() // 2, verbose=-1) # linear_tree=True
...
#                   'num_leaves': 19, 
#                   'learning_rate': 0.046407238709264644, 
#                   'n_estimators': 1220, 
#                   'colsample_bytree': 0.8312585492418, 
#                   'subsample': 0.84147634768488, 
#                   'feature_fraction': 0.9861489254222437, 
#                   'min_gain_to_split': 9.479400587354975, 
#                   'reg_alpha': 2.702546561764053, 
#                   'reg_lambda': 0.27946343733889023, 
#                   'linear_tree': False}